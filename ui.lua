...
--[[   CloseIcon.Name = "CloseIcon"
   ...
   UserTag.TextColor3 = Color3.fromRGB(135, 102, 255)
   ...
   function EngUi:Notification(titletext, desctext, btntext)
      ...
      AlrightBtn.MouseEnter:Connect(function()
         TweenService:Create(
            AlrightBtn,
            TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {BackgroundColor3 = Color3.fromRGB(135, 102, 255)}
         ):Play()
      end)
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      Server.TextColor3 = Color3.fromRGB(135, 102, 255)
      ...
      ServerTitle.TextColor3 = Color3.fromRGB(135, 102, 255)
      ...
      function ChannelHold:Channel(text)
         ...
         ChannelBtn.MouseButton1Click:Connect(function()
            ...
            ChannelBtn.BackgroundColor3 = Color3.fromRGB(10,10,10)
            ChannelBtnTitle.TextColor3 = Color3.fromRGB(200, 207, 255)
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            Toggle.MouseButton1Click:Connect(function()
               if toggled == false then
                  ...
                  TweenService:Create(ToggleFrame,TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = Color3.fromRGB(112, 102, 255)}):Play()
         ...
         function ChannelContent:Slider(text, min, max, start, callback)
            ...
            SliderTitle.BackgroundColor3 = Color3.fromRGB(135, 102, 255)
            ...
            CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(112, 102, 255)
         ...
         function ChannelContent:Line()
            ...
            Seperator2.BackgroundColor3 = Color3.fromRGB(138, 0, 169)
         ...
         function ChannelContent:Dropdown(text, sletext, list, callback)
            ...
            DropItemHolder.ScrollBarImageColor3 = Color3.fromRGB(135, 102, 255)
         ...
         function ChannelContent:Colorpicker(text, preset, callback)
            ...
            HueGradient.Color = ColorSequence.new {
               ...
               ColorSequenceKeypoint.new(0.60, Color3.fromRGB(135, 102, 255)),
